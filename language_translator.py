...
Label(Screen, text="Choose a language").grid(row=0, column=2)
...
Label(Screen, text="Translated Text").grid(row=2, column=2)
OutputVar= StringVar()
TextBox= Entry(Screen, textvariable=OutputVar).grid(row=2, column=3)

button= Button(Screen, text="Translate", command=Translate, relief=GROOVE).grid(row=3, column=1, columnspan=3)
